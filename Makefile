...
PROJ_OBJ += crtp_commander_generic.o crtp_localization_service.o peer_localization.o crtp_ae483_service.o
...
PROJ_OBJ += controller.o controller_pid.o controller_mellinger.o controller_indi.o controller_ae483.o
